  ...
  <v-app id="keep">
    <v-app-bar app clipped-left color="amber">
      ...
      <span class="title ml-3 mr-5"
        >Admin&nbsp;<span class="font-weight-light">Dashboard</span></span
      >
      <v-text-field
        solo-inverted
        flat
      ...
      <v-spacer></v-spacer>
      <v-btn icon color="grey" href="AdminHome">
              ...
              <v-list>
                <v-list-item>
                  ...
                  <template>
                    ...
                    <v-dialog v-model="dialoglogout" max-width="310">
                      <v-card>
                        <v-card-title class="headline"
                          >Do You want to Logout?</v-card-title
                        >
